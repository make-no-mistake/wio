...
describe("appAndSiteSpaceSwitch", () => {
  describe("normal requests", () => {
    ...
    it("should not rewrite when no subdomain exists", () => {
      const req = createMockRequest("wio.dev", "/dashboard");
      const result = appAndSiteSpaceSwitch(req);
