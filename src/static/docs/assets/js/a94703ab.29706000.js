  ...
  [48],
  {
    8115(e, t, n) {
      ...
      var a = n(6540),
        ...
        d = n(3104),
        u = n(5062);
      const m = "backToTopButton_sjWU",
        b = "backToTopButtonShow_xfvO";
      var h = n(4848);
      function p() {
      ...
      const A = "collapseSidebarButton_PEFL",
        C = "collapseSidebarButtonIcon_kv0_";
      function k({ onClick: e }) {
        return (0, h.jsx)("button", {
          ...
          onClick: e,
          children: (0, h.jsx)(_, { className: C }),
        });
      }
      var S = n(5041),
        N = n(9532);
      ...
      const R = "categoryLink_byQd",
        U = "categoryLinkLabel_W154";
      function F({ collapsed: e, categoryLabel: t, onClick: n }) {
        return (0, h.jsx)("button", {
          "aria-label": e
            ? (0, c.T)(
                {
      ...
      function z({
        ...
        const { items: d, label: u, collapsible: m, className: b, href: p } = e,
          ...
          f = (0, l.w8)(e, n),
          v = (0, w.ys)(p, n),
          { collapsed: _, setCollapsed: A } = (0, L.u)({
        ...
        })({ isActive: f, collapsed: _, updateCollapsed: S, activePath: n }),
          (0, a.useEffect)(() => {
            m && null != C && C !== r && x && A(!0);
          }, [m, C, r, A, x]));
        return (0, h.jsxs)("li", {
      ...
      const q = "menuHtmlItem_M9Kj";
      function O({ item: e, level: t, index: n }) {
      ...
      function Q({ item: e, ...t }) {
        switch (e.type) {
          ...
          case "html":
            return (0, h.jsx)(O, { item: e, ...t });
          default:
            return (0, h.jsx)(D, { item: e, ...t });
        }
      }
      function Z({ items: e, ...t }) {
        const n = (0, l.Y)(e, t.activePath);
        return (0, h.jsx)(y, {
          children: n.map((e, n) =>
            (0, h.jsx)(Q, { item: e, index: n, ...t }, n),
          ),
        });
      }
      const J = (0, a.memo)(Z),
      ...
      function ee({ path: e, sidebar: t, className: n }) {
        ...
        return (0, h.jsx)("nav", {
          ...
          children: (0, h.jsx)("ul", {
            ...
            children: (0, h.jsx)(J, { items: t, activePath: e, level: 1 }),
          }),
        });
      }
      const te = "sidebar_njMd",
        ne = "sidebarWithHideableNavbar_wUlq",
        ae = "sidebarHidden_VK0M",
        ie = "sidebarLogo_isFc";
      ...
      const be = "expandButton_TmdG",
        he = "expandButtonIcon_i1dp";
      function pe({ toggleSidebar: e }) {
        return (0, h.jsx)("div", {
          ...
          onKeyDown: e,
          onClick: e,
          children: (0, h.jsx)(_, { className: he }),
        });
      }
      const xe = {
      ...
      function ve({ hiddenSidebarContainer: e, children: t }) {
        ...
        return (0, h.jsx)("main", {
          className: (0, i.A)(
            ge.docMainContainer,
            (e || !n) && ge.docMainContainerEnhanced,
          ),
          children: (0, h.jsx)("div", {
            className: (0, i.A)(
              "container padding-top--md padding-bottom--lg",
              ge.docItemWrapper,
              e && ge.docItemWrapperEnhanced,
            ),
            children: t,
          }),
        });
      }
      const _e = "docRoot_UBD9",
        Ae = "docsWrapper_hBAB";
      ...
      function Se(e) {
        ...
        return (0, h.jsx)(s.e3, {
          ...
          children: (0, h.jsx)(r.V, {
            name: a,
            items: c,
            children: (0, h.jsx)(Ce, { children: n }),
          }),
        });
      }
    },
    3363(e, t, n) {
      ...
      function l({ className: e }) {
        return (0, o.jsx)("main", {
          className: (0, a.A)("container margin-vert--xl", e),
