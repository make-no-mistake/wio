...
3. **SDK & CLI Maturation**: We added CLI authentication (`wio login`) and expanded the frontend SDK (audio player and DB helpers) so developers (and AI agents) have robust tools to scaffold and connect UI to our backend APIs.
